...
/*!
 * returns \a true if the URL represents an Akonadi item and has one of the given mimetypes.
 */
...
/*!
 * returns \a true if the mime data object contains any of the following:
 *
...
/*!
  ...
  \sa KCalendarCore::CalFilter::apply()
  \a items the list of items to filter
  \a filter the filter to apply to the list of items
...
/*!
  ...
  \a will contain the dialogCode, QDialog::Accepted if the user pressed Ok,
  QDialog::Rejected otherwise
  \a parent The optional parent of the modal dialog.
  Returns The select collection or an invalid collection if
...
/*!
 * Returns a list containing work days between \a start and @end.
 */
